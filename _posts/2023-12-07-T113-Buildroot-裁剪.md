...
# Buildroot 2019.02.1-00010-g9cdf1909e0-dirty Configuration
#
...
BR2_LZCAT="lzip -d -c"
BR2_TAR_OPTIONS=""
BR2_DEFCONFIG="$(TOPDIR)/configs/sun8iw20p1_t113_defconfig"
...
#
BR2_TOOLCHAIN_EXTERNAL_LINARO_ARMSF=y
...
BR2_PACKAGE_PROVIDES_TOOLCHAIN_EXTERNAL="toolchain-external-linaro-armsf"
BR2_TOOLCHAIN_EXTERNAL_PREFIX="arm-linux-gnueabi"
...
BR2_ROOTFS_OVERLAY=""
BR2_ROOTFS_POST_BUILD_SCRIPT="$(TOPDIR)/../../platform/config/buildroot/post_build.sh"
...
#
# BR2_AW_GSTREAMER1 is not set
# BR2_AW_WAYLAND is not set
# BR2_AW_WAYLAND_IVI_EXTENSION is not set
# BR2_AW_WAYLAND_PROTOCOLS is not set
# BR2_AW_WESTON is not set
# BR2_AW_MESA3D is not set
# BR2_PACKAGE_DEMO is not set
# BR2_PACKAGE_MTOP is not set
BR2_PACKAGE_LONGAN_INFO=y
BR2_PACKAGE_MONITOR_USB=y
# BR2_PACKAGE_LIBCEDARC is not set
# BR2_PACKAGE_CEDARX is not set
# BR2_PACKAGE_BOOT_PLAY is not set
# BR2_PACKAGE_MEDIAPLAYER is not set

#
# nativepower
#
# BR2_PACKAGE_LIBSUSPEND is not set
# BR2_PACKAGE_LIBNATIVEPOWER is not set
# BR2_PACKAGE_LIBSCENEMANAGER is not set
# BR2_PACKAGE_NATIVEPOWER_DAEMON is not set
# BR2_PACKAGE_NATIVEPOWER_UTILS is not set

#
# ota
#
# BR2_PACKAGE_MISC_UPGRADE is not set
# BR2_PACKAGE_OTA_BURNBOOT is not set
BR2_PACKAGE_OTA_UPGRADE=y
# BR2_PACKAGE_LIBAWRESAMPLE is not set
# BR2_PACKAGE_LIBSPEEX_LITE is not set
# BR2_PACKAGE_RESAMPLE is not set
# BR2_PACKAGE_LIBCUTILS is not set
BR2_PACKAGE_LIBSYS_INFO=y
# BR2_PACKAGE_MTP is not set
# BR2_PACKAGE_LOGWRAPPER is not set

#
# wifimanager
#
# BR2_PACKAGE_LIBWIFIMG is not set
# BR2_PACKAGE_WIFI_MANAGER_DEMO is not set
# BR2_PACKAGE_SMARTLINKD is not set
# BR2_PACKAGE_BLUETOOTH is not set
...
#
# opencv plugin needs OpenCV-2.4
#
...
#
# gstreamer support needs X.Org
#

#
# server and X11 client need X.Org
#
...
# BR2_PACKAGE_UBOOT_TOOLS_FIT_SUPPORT is not set
# BR2_PACKAGE_UBOOT_TOOLS_MKIMAGE is not set
# BR2_PACKAGE_UBOOT_TOOLS_MKENVIMAGE is not set
BR2_PACKAGE_UBOOT_TOOLS_FWPRINTENV=y
# BR2_PACKAGE_UBOOT_TOOLS_DUMPIMAGE is not set
...
# BR2_PACKAGE_TAGLIB_MP4 is not set
# BR2_PACKAGE_TAGLIB_ASF is not set
...
BR2_PACKAGE_X265=y
# BR2_PACKAGE_X265_CLI is not set
...
BR2_PACKAGE_LIBCURL_TLS_SUPPORT=y
...
# BR2_PACKAGE_LIBNFTNL_JSON is not set
...
# BR2_PACKAGE_CONNMAN_WIFI is not set
...
# BR2_PACKAGE_CONNMAN_DEBUG is not set
# BR2_PACKAGE_CONNMAN_CLIENT is not set
