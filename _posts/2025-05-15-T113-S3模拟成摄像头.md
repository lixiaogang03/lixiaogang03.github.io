...
[    5.536109] udc 4100000.udc-controller: registering UDC driver [g1]
[    5.543372] configfs-gadget gadget: adding 'uvc'/(ptrval) to config 'c'/(ptrval)
[    5.552200] configfs-gadget gadget: uvc: uvc_function_bind()
[    5.558581] configfs-gadget gadget: adding 'uvc'/(ptrval) --> -19
[    5.565909] configfs-gadget 4100000.udc-controller: driver->bind() failed: -19
[    5.574367] configfs-gadget 4100000.udc-controller: failed to start g1: -19

```

not attached 是设备还“没插上线”或者“没被主机认出”的状态，不代表 Gadget 配置错误，只是连接还没建立
