...
![screen_pinning_intercept](/images/ams/screen_pinning_intercept.png)
...
$ adb shell dumpsys activity | grep LockTask

 mLockTaskModeState=PINNED mLockTaskPackages (userId:packages)=
 mLockTaskModeTasks[TaskRecord{a66374e #57 A=com.sunmi.superpermissiontest U=0 StackId=1 sz=2}]
