...
```txt
  ...
  D  .060  2013-2042  bt_btif_storage         pid-2013                             E  btif_storage_get_adapter_property: Controller not ready! Unable to return Bluetooth Address
  D  .060  2013-2042  BluetoothServiceJni     pid-2013                             E  adapter_properties_callback: Status 1 is incorrect
  D  .183   276-300   android.ha....0-service and...ardware.bluetooth@1.0-service  E  vendor storage read success
  D  .183   276-300   android.ha....0-service and...ardware.bluetooth@1.0-service  E  Got local bdaddr for vendor storage 22:22:D1:CC:6E:CF
  D  .184   276-300   bt_h5_int               and...ardware.bluetooth@1.0-service  E  OsAllocateTimer rtk_parse sigev.sigev_notify_thread_id = syscall(__NR_gettid)!
  D  .185   276-300   bt_h5_int               and...ardware.bluetooth@1.0-service  E  OsAllocateTimer rtk_parse sigev.sigev_notify_thread_id = syscall(__NR_gettid)!
  D  .186   276-300   libbt_vendor            and...ardware.bluetooth@1.0-service  E  bt_wake_up_host_mode_set(1)
  D  .186   276-300   bt_upio                 and...ardware.bluetooth@1.0-service  E  bt_wake_up_host_mode_set
  D  .186   276-300   bt_upio                 and...ardware.bluetooth@1.0-service  E  bt_wake_up_host_mode_set path:/proc/bluetooth/sleep/lpm
  D  .186   276-300   bt_upio                 and...ardware.bluetooth@1.0-service  E  bt_wake_up_host_mode_set fd:8 = open(path, O_RDWR): open(/proc/bluetooth/sleep/lpm) success
  D  .186   276-300   bt_upio                 and...ardware.bluetooth@1.0-service  E  bt_wake_up_host_mode_set buffer:49
  D  .186   276-300   libbt_vendor            and...ardware.bluetooth@1.0-service  E  rtk_btsnoop_dump = 0, rtk_btsnoop_save_log = 0
...
```txt
  ...
  D  .028  2013-2013  BluetoothServiceJni     pid-2013                             I  hal_util_load_bt_library: loaded Bluetooth library successfully
  D  .056  2013-2013  bt_btif                 pid-2013                             I  init: start restricted = 0 ; niap = 0, config compare result = 0
  D  .056  2013-2013  bt_btif                 pid-2013                             I  init Preserving legacy bluetooth functionality
  D  .056  2013-2013  bt_osi_all...on_tracker pid-2013                             D  canary initialized
  D  .057  2013-2037  droid.bluetoot          pid-2013                             I  [0326/184852.057007:INFO:message_loop_thread.cc(175)] Run: message loop starting for thread bt_stack_manager_thread
  D  .057  2013-2037  bt_stack_manager        pid-2013                             I  event_init_stack is initializing the stack
  D  .058  2013-2040  bt_osi_thread           pid-2013                             I  run_thread: thread id 2040, thread name alarm_default_ca started
  D  .058  2013-2041  bt_osi_thread           pid-2013                             I  run_thread: thread id 2041, thread name alarm_dispatcher started
  D  .058  2013-2037  bt_btif_core            pid-2013                             I  btif_init_bluetooth entered
  D  .058  2013-2037  bt_stack_config         pid-2013                             I  init attempt to load stack conf from /etc/bluetooth/bt_stack.conf
  D  .059  2013-2042  droid.bluetoot          pid-2013                             I  [0326/184852.059266:INFO:message_loop_thread.cc(175)] Run: message loop starting for thread bt_jni_thread
  D  .059  2013-2037  bt_btif_core            pid-2013                             I  btif_init_bluetooth finished
  D  .059  2013-2037  bt_stack_manager        pid-2013                             I  event_init_stack finished
  D  .059  2013-2013  bt_osi_wakelock         pid-2013                             I  wakelock_set_os_callouts set to non-native
  D  .059  2013-2013  bt_btif                 pid-2013                             I  get_profile_interface: id = socket
...
// 错误日志
  ...
  D  .065  2013-2013  bt_btif                 pid-2013                             I  get_profile_interface: id = bluetooth_keystore
  D  .067  2013-2013  bt_btif                 pid-2013                             I  get_profile_interface: id = sdp
  D  .169  2013-2013  bt_btif                 pid-2013                             I  get_profile_interface: id = gatt
  D  .178  2013-2037  bt_stack_manager        pid-2013                             I  event_start_up_stack is bringing up the stack
  D  .178  2013-2037  bt_core_module          pid-2013                             I  module_start_up Starting module "btif_config_module"
  D  .178  2013-2037  bt_core_module          pid-2013                             I  module_start_up Started module "btif_config_module"
  D  .178  2013-2037  bt_core_module          pid-2013                             I  module_start_up Starting module "btsnoop_module"
  D  .179  2013-2037  bt_core_module          pid-2013                             I  module_start_up Started module "btsnoop_module"
  D  .179  2013-2037  bt_core_module          pid-2013                             I  module_start_up Starting module "hci_module"
  D  .179  2013-2037  bt_hci                  pid-2013                             I  hci_module_start_up
  D  .180  2013-2056  droid.bluetoot          pid-2013                             I  [0326/184852.180148:INFO:message_loop_thread.cc(175)] Run: message loop starting for thread bt_hci_thread
  D  .180  2013-2037  bt_hci                  pid-2013                             D  hci_module_start_up starting async portion
  D  .180  2013-2056  bt_hci                  pid-2013                             I  hci_initialize
  D  .181  2013-2056  bt_hci                  pid-2013                             I  hci_initialize: IBluetoothHci::getService() returned 0xb4000078058dcf10 (remote)
...
**and...ardware.bluetooth@1.0-service日志**
...
## Realtek_Bluetooth_Porting_Guide_for_BT_Android11.0
